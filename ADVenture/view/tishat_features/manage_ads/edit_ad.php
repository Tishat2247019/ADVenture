...
<div class="left_ad_info_container">
    ...
    <div>
        ...
        <div>
            <textarea id="new_ad_description_id" name="new_ad_description" cols="30" rows="8"></textarea>
        </div>
    </div>
    ...
    <div>
        ...
        <div>
            <input id="new_ad_title_id" type="text" name="new_title" onkeyup="check_title()">
            <p class="red_validate" id="title_error">Length of Ad title should be at least 6</p>
        </div>
    </div>
</div>
...
<div class="right_ad_info_container">
    ...
    <div>
        ...
        <div>
            <input id="new_phone_id" type="text" name="new_phone" onkeyup="check_phone()">
            <p class="red_validate" id="phone_error">please enter a valid phone</p>
        </div>
    </div>
    ...
    <div>
        ...
        <div>
            <input id="new_email_id" type="email" name="new_email" onkeyup="check_email()">
    ...
    <div>
        ...
        <div>
            <input id="new_price_id" type="text" name="new_price" onkeyup="check_price()">
            <p class="red_validate" id="price_error">please enter a valid price</p>
        </div>
    </div>
    <div>
        <div>
    ...
    <div>
        ...
        <div>
            <select id="new_category_id" name="new_category" id="ad_category">
...
<div class="buttons_container">
    ...
    <div>
        <div>
            ...
            <p class="red_validate" id="all_error">Please Fill all the data correctly</p>
        </div>
    </div>
</div>
    ...
    <script src="../../../asset/js/edit_ad.js"></script>
