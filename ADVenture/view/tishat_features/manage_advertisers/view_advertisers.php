                    ...
                    <div class="advs_manage_contatiner">
                        ...
                        <div class="filter_container">
                            <div class="filter_advs_container">
                                ...
                                <p>Filter Advertisers by total ads</p>
                            </div>
                            <div class="filter_options_container">
                                <select name="" id="" onchange="display_advs_ajax(event,null, null, this.value)">
                                    <option value="ASC">Increaing Order</option>
                        ...
                        <div class="advs_status_container">
                                    ...
                                    <a href="" onclick="display_advs_ajax(event,'Active', null, null)">Active Advs</a>
                                    <a href="" onclick="display_advs_ajax(event,'Inactive', null, null)">Inactive Advs</a>
                                    <a href="" onclick="display_advs_ajax(event,'All', null,null)">All Advs</a>
