        ...
        <header class="header">
            ...
            <div class="menu_links">
                ...
                <li><a href="../dashboard/user_db.php?id=<?php echo $idd;  ?>">Dashboard</a></li>
                    <li><a href="../../rafi_features/view_ads.php?id=<?php echo $idd ?>">View Ads</a></li>
                    <li><a href="../../rafi_features/user_wishlist1.php?id=<?php echo $idd ?>">Wishlist</a></li>
                    <li><a href="../../rafi_features/ad_categories.html?id=<?php echo $idd ?>">Ad Categories</a></li>
                    <li><a href="../../rafi_features/search_ads.html?id=<?php echo $idd ?>">Search Ads</a></li>
                    <li><a href="../../rafi_features/user_feedback.html?id=<?php echo $idd ?>">Feedback</a></li>
