...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../asset/css/rafi_css_files/wishlist.css"></link>
    </head>
    <body>
        <form method="POST">
            <table align="center">
                                    ...
                                    <?php if (!empty($wishlist)) : ?>
                                        <?php foreach ($wishlist as $ad) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="ad_details.php?user_id=<?php echo $user_id;?>&id=<?php echo $ad['id']; ?>">View Saved Ad Details</a>
                                                </td>
                                                <td>
