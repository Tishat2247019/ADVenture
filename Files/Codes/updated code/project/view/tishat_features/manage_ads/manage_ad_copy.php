    ...
    <div class="main_container">
        <div class="container">
                    ...
                    <div class="ad_manage_contatiner">
                        ...
                        <div class="filter_container">
                            ...
                            <div class="filter_options_container">
                                <select name="" id="ad_category" onchange="ad_based_catecogry()">
            ...
            <tr align="center">
                ...
                <td>    
                        <a href="edit_ad.php?id=<?php echo $idd?>&idt=<?php echo $row['id']?>"> <img src="../../../asset/images/view_users_icons/edit2.ico" alt=""> </a> 
                    
                </td>
                <td>
                    
                        <a id="delete_user" href="../../../model/delete_ad.php?id=<?php echo $idd?>&idt=<?php echo $row['id']?>"> <img src="../../../asset/images/view_users_icons/delete.ico" alt=""> </a> 
