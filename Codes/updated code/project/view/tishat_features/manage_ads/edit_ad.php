...
<div>
    ...
    <div>
        <textarea id="new_ad_description" name="new_ad_description" cols="36" rows="10"><?php echo $description; ?></textarea>
    </div>
</div>
...
<div>
    ...
    <div>
        <p><a href="manage_ad.php?id=<?php echo $idd ?>"> Go Back</a></p>
    </div>
</div>
