...
<body>
                    ...
                    <div class="advs_manage_contatiner">
                        <div class="search_container">
                            ...
                            <div class="search_input_container">
                                ...
                                <button onclick="search_advs()">search</button>
                            </div>
                        </div>
                        ...
                        <div class="filter_container">
                            <div class="filter_advs_container">
                                ...
                                <p>Filter Advertisers by status</p>
                            </div>
                            <div class="filter_options_container">
                            <select name="" id="" onchange="display_advs_ajax(event, this.value, null)">
    ...
    <script src="../../../asset/js/manage_advertisers.js"></script>
