...
<body>
    <div class="container">
        ...
        <form class="edit-profile-form">
            ...
            <input type="submit" value="Update Profile" class="update-button" onclick="edit_profile(event, <?php echo $idd; ?>)">
        </form>
        <section align="center" class="backbutton">
         <h3 id="success_h" style="color:red;display:none"></h3>
    ...
    <script src="../../../asset/js/opi_js/edit_profile.js"></script>
