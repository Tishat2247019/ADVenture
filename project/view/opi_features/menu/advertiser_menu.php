        ...
        <header class="header">
            ...
            <div class="menu_links">
                ...
                <li><a href="../dashboard/advertiser_db.php?id=<?php echo $idd;  ?>">Dashboard</a></li>
                    <li><a href="../../shohan_features/create_ad/ad.php?id=<?php echo $idd;  ?>">Create Ad</a></li>
                    <li><a href="../../shohan_features/manage_ad/manage_ad.php?id=<?php echo $idd;  ?>">Manage Ads</a></li>
                    <li><a href="../../shohan_features/ad_analytics/ad_analytics.html?id=<?php echo $idd;  ?>">Ad Analytics</a></li>
                    <li><a href="../../shohan_features/profile_advertiser/view_profile.php?id=<?php echo $idd;  ?>">View Profile</a></li>
                    <li><a href="../../shohan_features/profile_advertiser/edit_profile.php?id=<?php echo $idd;  ?>">Edit Profile</a></li>
                    <li><a href="../../shohan_features/profile_advertiser/cng_pro_pic.php?id=<?php echo $idd;  ?>">Change Profile Photo</a></li>
                    <li><a href="../../shohan_features/profile_advertiser/cng_password.php?id=<?php echo $idd;  ?>">Change Password</a></li>
