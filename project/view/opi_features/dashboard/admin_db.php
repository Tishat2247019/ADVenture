...
$num_of_reported_ads = mysqli_num_rows($reported_ads);
        ...
        <div class="container">
            ...
            <div class="welcome_admin">
                ...
                <div class="dashboard">
                    ...
                    <div class="section">
                        <h2><a href="../../tishat_features/report_ads/reported_ads.php?id=<?php echo $idd; ?>"> Reported Ads</a></h2>
                        <p><?php echo $num_of_reported_ads; ?></p>
                    </div>
                </div>
